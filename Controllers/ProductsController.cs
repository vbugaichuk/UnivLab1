...
namespace DBIT.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var dBITCompanyContext = _context.Products.Include(p => p.ItCompany);
        ...
        public async Task<IActionResult> Create([Bind("Name,Year,Budget,ItCompanyId,Id")] Product product)
        {
