...
namespace DBIT.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, string? name)
        {
            ...
            //знаходження міст за країнами
            ViewBag.CountryId = id;
            ViewBag.CountryName = name;
            var citiesByCountry = _context.Cities.Where(b => b.CountryId == id).Include(b => b.Country);
            //var dBITCompanyContext = _context.Cities.Include(c => c.Country);
